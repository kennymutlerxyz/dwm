...
static char *fonts[]          = { "Inconsolata:size=15.3", "fontawesome:pixelsize=15.3:antialias=true:autohint=true"  };
...
static Key keys[] = {
	...
	{ MODKEY,			XK_e,		spawn,		SHCMD(TERMINAL " -e mail ; pkill -RTMIN+12 dwmblocks; rmdir ~/.abook") },
